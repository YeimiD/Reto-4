...
public class UserMenu extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel6Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel6Layout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(cbZona, javax.swing.GroupLayout.PREFERRED_SIZE, 85, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(18, 18, 18)
                .addComponent(jLabel9)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(cbTipoCalle, 0, 106, Short.MAX_VALUE)
                .addGap(18, 18, 18)
        ...
        if (tblEmpleados1.getColumnModel().getColumnCount() > 0) {
            tblEmpleados1.getColumnModel().getColumn(0).setResizable(false);
        }
    ...
    private void tblEmpleados1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblEmpleados1MouseClicked
        ...
        String nombreEmp = tblEmpleados1.getValueAt(nroFila, 0).toString();
        String apellidos = tblEmpleados1.getValueAt(nroFila, 1).toString();
        String tipoDocumento = tblEmpleados1.getValueAt(nroFila, 2).toString();
        String documento = tblEmpleados1.getValueAt(nroFila, 3).toString();
        String correo = tblEmpleados1.getValueAt(nroFila, 4).toString();
        String nombreSucursal = tblEmpleados1.getValueAt(nroFila, 5).toString();
    ...
    private void btnGuardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGuardarActionPerformed
        ...
        if (departamentoOption.equals("Selecciona_una_opcion") || zonaOption.equals("Selecciona_una_opcion") || tipoCalleOption.equals("Selecciona_una_opcion") || numero1.isEmpty() || numero2.isEmpty() || numero3.isEmpty()) {
            JOptionPane.showMessageDialog(this, "No se resgistro la dirección. Faltan campos por suministrar", "Dirección Sucursal", JOptionPane.ERROR_MESSAGE);
        } else {
    ...
    private void tblDepartamentosMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblDepartamentosMouseClicked
        ...
        String direccion = tblDepartamentos.getValueAt(nroFila, 2).toString();
